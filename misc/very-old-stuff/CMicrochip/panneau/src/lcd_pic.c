// F. Chaxel 2008 d'apr�s code D. Dubosc pour 8031
#include "lcd_pic.h"
...
void EcrireLCDdemi(Uchar c, Uchar Put_Cmd)
{
    RS_PIN = Put_Cmd;
#ifdef FAIBLE
    DATA_PORT &= 0xF0;
...
void EcrireLCD(Uchar c, Uchar Put_Cmd)
{
...
void MessageLCDram(Uchar *m)
{
    AddCar = ADD_LG1;
    EcrireLCD(AddCar, CMD);  // Position 1�re lg en DD RAM
